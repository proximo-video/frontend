              ...
              <div className="reveal-from-bottom" data-reveal-delay="600">
                <ButtonGroup>
                  <Button tag="a" color="dark" wideMobile href="https://accounts.google.com/o/oauth2/v2/auth?client_id=287838666978-fnnt6fujf4malkfn3ppoqrrdcfqk75h1.apps.googleusercontent.com&redirect_uri=http://localhost:8000/welcome.html&response_type=code&scope=profile">
                    Login with <img className="logo" src={GoogleLogo}></img>
                    </Button>
                  <Button tag="a" wideMobile href="https://github.com/login/oauth/authorize?client_id=a3b7842c5f4c93cc4b7d&redirect_uri=http://localhost:8000/welcome">
                  Login with <img className="logo" src={GithubLogo}></img>
                    </Button>
                </ButtonGroup>
              </div>
            </div>
